...
def repair_time_series(dataframe, timestamp_col = 'timestamp', cols_not_to_fill = [], fillna_method = 'pad', freq = 'T'):
    ...
    # Reindex with date range to fill missing timestamps (freq arguments can be found in pandas documentation)
